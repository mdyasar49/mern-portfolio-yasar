 ...
 */
exports.getBasicDetails = asyncHandler(async (req, res) =>
  processAndSendFragment('basic_info', res),
);
...
exports.getAnalytics = asyncHandler(async (req, res) => {
  ...
  const skillsData = fs.existsSync(skillsPath)
...
exports.getCommonLayout = asyncHandler(async (req, res) => {
  ...
  const socialsData = fs.existsSync(socialsPath)
    ? JSON.parse(fs.readFileSync(socialsPath, 'utf-8'))
    : {};
