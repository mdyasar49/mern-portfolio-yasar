                ...
                <head>
                    <style>
                        @media only screen and (max-width: 600px) {
                            .main-container { padding: 20px !important; border-radius: 10px !important; }
                            .meta-grid { display: block !important; }
                            .meta-item { margin-bottom: 10px !important; width: auto !important; flex: none !important; }
                            .header-title { font-size: 24px !important; }
                            .message-body { padding: 20px !important; font-size: 15px !important; }
                        }
                    </style>
                </head>
                <body style="margin: 0; padding: 0; background-color: #000000;">
                    <div class="main-container" style="background-color: #030303; color: #ffffff; padding: 40px; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 20px auto; border-radius: 20px; border: 1px solid #1a1a1a; box-shadow: 0 50px 100px rgba(0,0,0,0.8);">
                        <div style="border-bottom: 2px solid #e11d48; padding-bottom: 25px; margin-bottom: 35px; text-align: left;">
                            <h1 class="header-title" style="margin: 10px 0 0 0; font-size: 32px; font-weight: 900; letter-spacing: -1px; line-height: 1.1;">New Message <span style="color: #e11d48;">Received.</span></h1>
                        </div>

                        <!-- Meta Data Grid -->
                        <div class="meta-grid" style="display: flex; gap: 10px; margin-bottom: 30px;">
                            <div class="meta-item" style="flex: 1; background: #0a0a0a; border: 1px solid #1f1f1f; padding: 20px; border-radius: 12px;">
                        ...
                        <div style="background: #0a0a0a; border: 1px solid #1f1f1f; padding: 20px; border-radius: 12px; margin-bottom: 30px;">
                            ...
                            <a href="mailto:${email}" style="color: #e11d48; text-decoration: none; font-size: 14px; font-weight: 600; word-break: break-all;">${email}</a>
                        </div>

                        <!-- Message Body -->
                        <div class="message-body" style="background: rgba(225, 29, 72, 0.03); border: 1px solid rgba(225, 29, 72, 0.1); border-left: 5px solid #e11d48; padding: 30px; border-radius: 12px;">
      ...
      subject: `Thank you for reaching out: ${subject || 'Connection Request'}`,
        html: `
                ...
                <head>
                    <style>
                        @media only screen and (max-width: 600px) {
                            .main-container { padding: 25px 20px !important; border-radius: 10px !important; }
                            .header-title { font-size: 24px !important; }
                            .response-box { padding: 20px !important; }
                            .response-time { font-size: 20px !important; }
                        }
                    </style>
                </head>
                <body style="margin: 0; padding: 0; background-color: #000000;">
                    <div class="main-container" style="background-color: #030303; color: #ffffff; padding: 40px; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 20px auto; border-radius: 20px; border: 1px solid #1a1a1a; box-shadow: 0 50px 100px rgba(0,0,0,0.8);">
                        ...
                        <h1 class="header-title" style="font-size: 28px; font-weight: 900; letter-spacing: -0.5px; text-align: center; margin-bottom: 25px;">Hello ${name},</h1>
                        ...
                        <div class="response-box" style="background: #0a0a0a; border: 1px solid #1f1f1f; padding: 25px; border-radius: 12px; text-align: center; margin-bottom: 35px;">
                            <p style="color: #e11d48; font-weight: 800; font-size: 12px; margin-bottom: 5px; text-transform: uppercase;">Response Time</p>
                            <p class="response-time" style="color: #ffffff; font-size: 24px; font-weight: 900; margin: 0;">Within 24 Hours</p>
                        </div>
